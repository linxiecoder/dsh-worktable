...
// src/index.ts
var PLUGIN_VERSION = false ? "dev" : "0.2.4";
var name = "dsh-worktable";
var inject = ["webServer", "sessions"];
var HEALTH_PATH = "/api/worktable/health";
var MAX_ENTRIES = 500;
var MODE_SETTINGS_PATH = pathResolve(homedir(), ".dsh", "storages", "dsh-worktable-mode.json");
var FILE_TYPES = {
...
function isWorktableMode(value) {
...
async function writePersistedMode(mode) {
